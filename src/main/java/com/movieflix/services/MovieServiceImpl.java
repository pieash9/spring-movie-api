...
public class MovieServiceImpl implements MovieService{
    ...
    //  set movieDt0's poster value,
        movieDto.setPoster(fileName);

    //  map it to Movie object according to step2
        Movie movie = new Movie(
                mv.getMovieId(),
                movieDto.getTitle(),
                movieDto.getDirector(),
    ...
    public MoviePageResponse getAllMoviesWithPagination(Integer pageNumber, Integer pageSize) {
        ...
        return new MoviePageResponse(movieDtos, pageNumber, pageSize, moviePages.getTotalElements(), (int) moviePages.getTotalPages(), moviePages.isLast() );
    }
